...
function getDraftSecret() {
	return "d7685621-0a24-41c9-ab44-eb2d07f0cc80";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7d0585b3-9aaa-4730-9770-909955fec018";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7d0585b3-9aaa-4730-9770-909955fec018") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7d0585b3-9aaa-4730-9770-909955fec018",
		rootBoundaryId
	});
}
/**
