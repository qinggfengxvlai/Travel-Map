...
function getDraftSecret() {
	return "5d0b1c55-5642-45d5-973c-519b36c24bbd";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6346744c-9729-41ee-afee-ba60536ae5ef";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6346744c-9729-41ee-afee-ba60536ae5ef") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6346744c-9729-41ee-afee-ba60536ae5ef",
		rootBoundaryId
	});
}
/**
